## ----scatres, echo=FALSE, eval=TRUE, message=FALSE, warning=FALSE, out.height="90%", fig.align='center'----
plot(x = seq(-5, 5, by = .1),
...
## ----reglog, echo=FALSE, eval=TRUE, message=FALSE, warning=FALSE, out.height="90%", fig.align='center'----
reglog <- function (x){
