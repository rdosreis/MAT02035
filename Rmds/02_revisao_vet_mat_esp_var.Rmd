...
- $A$ é uma matriz com três linhas e quatro colnas.
...
- Por serem uma combinção de vetores, cada função terá um ou mais vetores como inputs e retornará uma matriz.
...
- Uma matriz quadrada é __simétrica__ se esta é iqual à sua matriz transposta.
...
- Exemplos de matrizes dimétricas que desempenham papel importante na análise de dados longitudinais são as matrizes de __covariância__ e __correlação__ para as correspondentes medidas repetidas nos mesmos indivíduos.
