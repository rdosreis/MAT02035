...
- Nos EUA (metade do século 20): mudança de suporte para pesquisa da área militar para a área biomédica.
...
- Esta correlação __invalida a suposição crucial de independência__ que é o pilar de tantas técnicas estatísticas.
    + Modelos estatísticos para dados correlacionados devem explicitamente descrever e levar em conta para esta correlação.
