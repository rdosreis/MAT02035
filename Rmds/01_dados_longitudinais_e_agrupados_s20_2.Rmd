...
- Mais tarde, na mesma década, \textbf{\textcolor{darkpastelgreen}{Liang e Zeger}} introduziram as __equações de estimativas generalizadas__ na literatura bioestatística e propuseram uma família de modelos lineares generalizados para ajustar observações repetidas de dados binários e contagens\footnote{Liang, K.Y., Zeger, S.L. Longitudinal Data Analysis Using Generalized Linear Models. \emph{Biometrika}, 73:13-22, 1986.}$^{,}$\footnote{Zeger, S.L., Liang, K.Y. Longitudinal Data Analysis for Discrete and Continuous Outcomes. \emph{Biometrics}, 42:121-130, 1986.}.
