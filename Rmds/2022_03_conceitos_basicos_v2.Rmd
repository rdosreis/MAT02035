...
- Nas ciências da saúde, os __estudos longitudinais__ desempenham um papel importante em aumentar nossa compreensão do __desenvolvimento__ e __persistência__ da doença.
...
- \structure{Delineamento de estudo longitudinal:} permite a descoberta de características individuais que podem explicar essas __diferenças interindividuais__ nas __mudanças nos resultados__ de saúde __ao longo do tempo__.
...
- A \structure{característica definidora de um estudo longitudinal} \alert{é que duas ou mais observações da variável resposta, realizadas em momentos diferentes, são obtidas em pelo menos alguns dos participantes do estudo}.
...
- O \structure{objetivo principal} de um estudo longitudinal é __caracterizar a mudança na resposta ao longo do tempo__.
...
- Na forma mais elementar, uma medida da __mudança observada dentro de indivíduo__ na resposta pode ser conceituada em termos de  __"escores de mudança"__ ou __"escores de diferença"__.
...
- Quando há dados ausentes, um gráfico da resposta média sobre o tempo pode ser enganador.
    + \alert{Mudanças ao longo do tempo podem refletir o padrão de ausência de dados, e não de mudança individual}.
