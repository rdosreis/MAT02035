...
- Essa noção simples de mudança intraindividual se estende naturalmente de "escores de diferença" a __"trajetórias de resposta"__ mais gerais ao longo do tempo. 
...
- No entanto, outros tipos de trajetórias de resposta, por exemplo, __lineares por partes__ ou __curvilíneas__, podem ser usados para suavizar parcimoniosamente e resumir as mudanças intraindividuais na resposta ao longo da duração do estudo.
...
- Em um estudo longitudinal, os participantes, ou, mais geralmente, as unidades em estudo, são referidas como __indivíduos__ ou __sujeitos__. 
    ...
    + Em outros estudos longitudinais, os indivíduos podem ser animais ou objetos.
...
- Por exemplo, o nível de colesterol LDL seria considerado independente do sexo se a distribuição do nível de colesterol LDL fosse a mesma para em indivíduos do sexo feminino e masculino.
