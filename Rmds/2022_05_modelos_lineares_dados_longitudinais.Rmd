...
i. Covariáveis cujos __valores não mudam__ ao longo da duração do estudo. \structure{Exemplo:} tratamentos experimentais fixos.
ii. Covariáveis cujos __valores mudam__ ao longo do tempo. \structure{Exemplo:} o tempo desde a linha de base, idade do indivíduo, o status atual do tabagismo e as exposições ambientais.
...
\begin{mybox}{distribuição conjunta}
...
- __Próxima aula:__ modelos lineares para dados longitudinais (abordagens de modelagem).
